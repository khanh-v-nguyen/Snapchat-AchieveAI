...
import { StyleSheet, SafeAreaView, Platform, View, TextInput, Button, Image} from "react-native";
import { getChat } from "../testing/TestGetChatGPT.js";
...
const CHATBOT_USER_OBJ = {
  ...
  avatar: "https://blog.redbubble.com/wp-content/uploads/2019/05/Grumpy-Cat-Blog-Square.png",
};
...
async function respondToUser (userMessages) {
  ...
  function MyTimer() {
    return <Image source={require("../../assets/snapchat/defaultprofile.png")}/>
  }
  ...
  return (
    ...
    <View style={styles.studyModeContainer}>
        ...
        <TextInput style={styles.input} onChangeText={(text)=>setUserInput(text)}></TextInput>
