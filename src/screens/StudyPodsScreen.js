import {Text, View, Switch, StyleSheet, Image, TextInput, Button, ScrollView, TouchableOpacity} from 'react-native'
    ...
    <View style={[{flex:1, alignItems: 'center'}, 
        ...
        <View style={styles.studyModeContainer}>
            <ScrollView vertical={true} style={{height:'70%'}}>
                <ChatBubble name="Sammy" color="red" message="i'm freaking out, we need to complete the assignments for final showcase"/>
                <ChatBubble name="Joshua" color="purple" message="ok its pods time"/>
                <ChatBubble name="Sammy" color="red" message="have you guys finished your deliverables?"/>
                <ChatBubble name="invite" color="green" message="omg i love pods 😭"/>
                <ChatBubble name="Megha" color="purple" message="no let's do it over call"/>
                <ChatBubble name="Megha" color="purple" message="remember we need to keep our study streak"/>
                <ChatBubble name="David" color="red" message="I'll set a timer for us!"/>
        ...
        <BottomSheetModalProvider>
            <BottomSheetModal snapPoints={["40%"]} ref={bottomSheetModalRef} index={0} backgroundStyle={{backgroundColor: "#F7F8FA"}}>
                <ScrollView vertical={true}>
                    <View style={styles.sheetContainer}>

                        <TouchableOpacity style={{alignSelf:'center'}}>
                            <Image style={styles.sheetButton} source={require("../../assets/screenshots/Cell.png")}/>
                        </TouchableOpacity>

                        <View>
                            <Text style={{fontWeight: 'bold', marginTop: 20}}>In this Pod</Text>
